...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(651, 385);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(564, 32);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Your Order has been placed Succesfully!!!\r\n";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Arial", 20.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(674, 498);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(527, 32);
			this->label2->TabIndex = 1;
			this->label2->Text = L"ThankYou for choosing TASTY TRAILS\r\n";
			this->label2->Click += gcnew System::EventHandler(this, &PlaceOrder::label2_Click);
			// 
			// pictureBox1
			// 
			this->pictureBox1->BackColor = System::Drawing::Color::Transparent;
			this->pictureBox1->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.BackgroundImage")));
			this->pictureBox1->Location = System::Drawing::Point(833, 609);

...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		OOPFINALPROJECTSEMESTER2::bbqtonight^ bbq = gcnew OOPFINALPROJECTSEMESTER2::bbqtonight();
		bbq->Show();
		this->Hide();
	}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	OOPFINALPROJECTSEMESTER2::DajjajBroast^ db = gcnew OOPFINALPROJECTSEMESTER2::DajjajBroast();
	db->Show();
	this->Hide();
}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	OOPFINALPROJECTSEMESTER2::BunduKhanRestaurant^ bkr = gcnew OOPFINALPROJECTSEMESTER2::BunduKhanRestaurant();
	bkr->Show();
	this->Hide();
}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	OOPFINALPROJECTSEMESTER2::ksb^ k= gcnew OOPFINALPROJECTSEMESTER2::ksb();
	k->Show();
	this->Hide();
}
};
